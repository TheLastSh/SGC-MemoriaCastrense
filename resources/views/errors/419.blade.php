...
<div class="max-w-lg mx-auto text-center py-20">
    <h1 class="text-6xl font-display font-bold text-navy-900 mb-4">419</h1>
    <p class="text-xl text-gray-600 mb-2">Sesión expirada</p>
    <p class="text-gray-500 mb-8">Tu sesión ha expirado. Por favor, recarga la página e intenta de nuevo.</p>
